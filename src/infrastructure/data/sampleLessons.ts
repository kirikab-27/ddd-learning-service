...
export const lesson10_1 = Lesson.create({
  ...
  content: MarkdownContent.create(`LESSON10EOF
cat /tmp/lesson10-1-escaped.txt >> src/infrastructure/data/sampleLessons.ts
cat >> src/infrastructure/data/sampleLessons.ts << 'LESSON10EOF'
`),
  order: 1,
});
...
export const lesson10_2 = Lesson.create({
  ...
  content: MarkdownContent.create(`LESSON10EOF
cat /tmp/lesson10-2-escaped.txt >> src/infrastructure/data/sampleLessons.ts
cat >> src/infrastructure/data/sampleLessons.ts << 'LESSON10EOF'
`),
  order: 2,
});
